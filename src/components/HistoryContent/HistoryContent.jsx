  ...
  return (
    <div className='historyContent d-flex justify-content-center align-items-center'>
        <div className="col-md-6">
            ...
            <p>The imposing edifice designed in the English Gothic Revival architecture style was constructed using locally available BUFF-COLOURED BASALT (PORBUNDER STONE). Inside it is known for its wide gothic arches and beautiful stained glass windows.</p> 
            <p>The chapel has a nave and aisle with a chancel 50 ft (15 m) in length and 27 ft (7 m) in width. Butterfield's tiles used for the geometric floor pattern of the chancel were imported from England. 
            ...
            <p>THE CHURCH BELLS - An inscription on one bell reads:</p>
            <p>"WHENE'ER THE SWEET CHURCH BELL PEALS<br/>
              OVER HILL AND DELL<br/>
              MAY JESUS CHRIST BE PRAISED<br/>
              O HARK TO WHAT IT SINGS<br/> 
              AS JOYOUSLY IT RINGS<br/>
              MAY JESUS CHRIST BE PRAISED"</p>
            <p>There are Eight large brass bells inside the bell tower that were made in 1904 by John Taylor and Co., founders of Loughborough (England), and are acknowledged to be the best in western India. The tower and spire are 198 ft (60 m) high, and the bells can be accessed by a spiral stone staircase inside the tower. Hymns and Carols can be played by pulling on ropes attached to each of the eight bells.</p>
            <img src="P7.jpg" alt="church 3" className='img-fluid w-100' /> <br/><br/>
            <img src="P4.jpg" alt="church 3" className='img-fluid w-100' /> <br/><br/>
            <img src="P2.jpg" alt="church 3" className='img-fluid w-100' /> <br/><br/>
        </div>
    </div>
  )
}
